package com.android.a19870101_jayasakthivelrajasekaran_nycshools.utils;
...
public class SchoolUtils {
    ...
    public static void showPhone(Context mContext, String number){
        if (ContextCompat.checkSelfPermission(mContext,
                Manifest.permission.CALL_PHONE)
                != PackageManager.PERMISSION_GRANTED) {

            ActivityCompat.requestPermissions((DashboardActivity)mContext,
